...
import ProgramDimensionCard from '@/skripsi/components/program-dimension-card';
...
const ProgramDimensionSectionView: React.FC<ProgramDimensionProps> = ({
  className,
  programs,
  isLoading,
  cardCareer,
