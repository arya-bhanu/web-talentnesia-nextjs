        ...
        <>
        {
            ...
            (
                <div className="animate-pulse mb-2.5" style={{width: props.width ? props.width : '100%', ...props.containerStyle}}>
                    <div className=" bg-gray-200 rounded-full dark:bg-gray-700 " style={{height: props.height ? props.height : 20}}></div>
                </div>
            ) : props.visible && props.variant === 'image' ? 
            (
                <div className="animate-pulse mb-2.5" style={{width: props.width ? props.width : '100%', ...props.containerStyle}}>
                    <div className="flex items-center justify-center bg-gray-300 rounded dark:bg-gray-700" style={{height: props.height ? props.height : '80%'}}>
            ...
            (
                <div className="animate-pulse mb-2.5" style={{width: props.width ? props.width : '100%', ...props.containerStyle}}>
                    <div className="flex items-center justify-center bg-gray-300 rounded-lg dark:bg-gray-700" style={{height: props.height ? props.height : '80%'}}>
