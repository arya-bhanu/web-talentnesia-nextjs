...
const AllClassView: React.FC<AllClassProps> = ({
  ...
  return (
    <div className="flex flex-col">
      ...
      />
      {!isLoading && (
        <h2 className="font-poppins font-semibold text-slate-800 text-center text-xl sm:text-2xl md:text-start lg:mt-28 lg:text-3xl">
          {title}
        </h2>
      )}

<div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 md:mt-20">
        ...
        <div className="md:w-3/4">
          <div className="flex items-center justify-between mb-6 space-x-4">
            ...
            <div
              ...
              style={isLoading === true ? { minWidth: 300 } : undefined}
            >
              <SkeletonLoader
                visible={isLoading ? isLoading : false}
                width={'25%'}
