...
export const ContactFormView: React.FC<ContactFormViewProps> = ({
  ...
  return (
    ...
    >
      <SkeletonLoader visible={isLoading ? isLoading : false} height={40} width={'50%'}/>
      <SkeletonLoader visible={isLoading ? isLoading : false} height={18} containerStyle={{marginTop: 20}}/>
      <SkeletonLoader visible={isLoading ? isLoading : false} height={18} width={'30%'}/>
      {
        !isLoading &&
        <>
      ...
      <SkeletonLoader visible={isLoading ? isLoading : false}  width={'100%'} height={300} borderRadius={10} containerStyle={{marginTop: 32}}/>
      <SkeletonLoader visible={isLoading ? isLoading : false}  width={'18%'} height={37} containerStyle={{marginTop: 16}}/>
      {
        !isLoading &&
