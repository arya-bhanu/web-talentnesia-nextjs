...
export const ContactCardView = ({ className, isLoading }: { className?: string, isLoading?: boolean }) => {
  return (
    <section className={clsx(className, '')}>
      <div className="xl:w-[85%] overflow-x-auto text-wrap">
        <div className="rounded-xl space-y-8 md:space-y-12">
          {/* Partnership */}
          <div className="border border-[#D0D5DD] p-6 lg:p-8 rounded-2xl">
            <SkeletonLoader visible={isLoading ? isLoading : false} height={35} width={'40%'} containerStyle={{marginBottom: 35}}/>
            <SkeletonLoader visible={isLoading ? isLoading : false} width={'100%'} />
            <SkeletonLoader visible={isLoading ? isLoading : false} width={'70%'} containerStyle={{marginBottom: 32}}/>
            {
              !isLoading && 
              <>
            ...
            <div>
              {supportData.map((item, index) => (
                ...
                >
                  <SkeletonLoader visible={isLoading ? isLoading : false} width={50} height={50} variant='circle-image' />
                  {
                    !isLoading &&
                  ...
                  <div style={isLoading === true ? {minWidth: 250} : undefined}>
                    <SkeletonLoader visible={isLoading ? isLoading : false} />
                    <SkeletonLoader visible={isLoading ? isLoading : false} height={15} containerStyle={{marginBottom: 18}} width={'45%'} />
                    {
                      !isLoading &&
                      <>
          ...
          <div className="border border-[#D0D5DD] p-6 lg:p-8 rounded-2xl">
            ...
            <div>
              ...
              <SkeletonLoader visible={isLoading ? isLoading : false} height={40} width={'40%'}/>
              {
                !isLoading &&
