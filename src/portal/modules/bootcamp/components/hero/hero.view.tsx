        ...
        <div className="flex-[1] text-center lg:text-left pt-10">
          ...
          <SkeletonLoader visible={isLoading ? isLoading : false} height={10} />
          {
            ...
            <h1 className="font-semibold text-[#2B2E33] font-poppins text-xl md:text-2xl lg:text-2xl xl:text-4xl lg:leading-normal xl:leading-[58px]">
              Unlock Your Potential: Elevate Your IT Skills with Industry-Leading Mentors
            </h1>
            <p className="text-[#2B2E33] text-base font-inter mt-7">
              Gain hands-on experience, refine your skills, and tackle real-world
              projects under the guidance of experts. With personalized
              mentorship, you will have the chance to engage in in-depth 
              discussions, receive valuable feedback, and accelerate your learning 
              journey.
            </p>
            </>
          }
