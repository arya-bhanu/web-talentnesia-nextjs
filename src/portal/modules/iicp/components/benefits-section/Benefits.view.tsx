  ...
  return (
    <section className={clsx(className, (className = 'bg-white'))}>
      <div className="flex flex-col lg:flex-row lg:items-start lg:text-left">
        <div className="w-full md:w-[40%] mb-6 lg:mb-0 lg:pr-2 md:mr-8 text-center md:text-left">
        ...
        <div className="w-full md:w-[55%] grid grid-cols-1 md:grid-cols-2 gap-4 text-center md:text-left">
