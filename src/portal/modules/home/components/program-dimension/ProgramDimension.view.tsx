...
> = ({ className, programs, isLoading }) => {
  return (
    <section className={className}>
      <SkeletonLoader visible={isLoading ? isLoading : false} width={530} height={35}/>
      ...
      <div className="mt-4 md:mt-7 lg:mt-10 flex gap-6 md:gap-7 lg:gap-10 md:flex-row flex-col flex-wrap">
        ...
        <div className="bg-[#E0F7FA] rounded-[8px] w-fit px-3 lg:px-4 xl:px-7 py-4 md:py-6 lg:py-8 flex-1 flex flex-col justify-between">
          <div className="max-w-[90%]">
            <SkeletonLoader visible={isLoading ? isLoading : false} width={250}/>
            <SkeletonLoader visible={isLoading ? isLoading : false} width={100} containerStyle={{marginBottom: 25}}/>
          ...
          <SkeletonLoader visible={isLoading ? isLoading : false} height={40} width={200} containerStyle={{marginTop: 18, marginBottom: 0}}/> 
          {
            !isLoading &&
