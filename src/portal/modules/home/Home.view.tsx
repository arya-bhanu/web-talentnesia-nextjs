  ...
  return (
    <>
      ...
      <main className="container">
        ...
        <ProgramDimension className="mt-14 md:mt-16 lg:mt-20" programs={data.programs} />
        <EliteClass className="mt-14 md:mt-16 lg:mt-24"  courses={data.courses}/>
        <UserStory className=" mt-14 sm:mt-28 md:mt-36 lg:mt-48" testimonials={data.testimonials}/>
        <Partners className="mt-16 md:mt-20 lg:mt-28" partners={data.partners}/>
