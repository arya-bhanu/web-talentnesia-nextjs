...
import { agendaData, classData, iicpData, studentData } from './dashboardOperator.data';
...
const DashboardOperatorview: React.FC<DashboardOperatorviewProps> = ({ selectedDate, onDateChange, dashboardData }) => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5 mb-6">
        ...
        <div className="bg-[#D8F1D9] overflow-hidden shadow sm:rounded-lg flex p-6 relative h-32">
          ...
          <div className="mt-12 flex flex-col">
            <div className="flex items-center">
              <div className="text-xl leading-9 font-bold text-gray-900">{dashboardData?.data.totalIicp || 0}</div>
