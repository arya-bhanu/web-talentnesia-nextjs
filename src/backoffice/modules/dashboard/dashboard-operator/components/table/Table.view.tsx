  ...
  const columns = useMemo<ColumnDef<any>[]>(
    () => [
      ...
      columnHelper.accessor('progress', {
        header: ({ column }) => <SortingTable column={column} title="Progress" />,
        cell: (info) => (
          <div className="flex flex-col">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xs md:text-sm text-gray-900">{info.getValue() as React.ReactNode || 0}% </span>
              <span className="ml-1 text-xs md:text-sm text-gray-900"> Selesai</span>
            </div>
          </div>
        ),
        size: 250,
  ...
  return (
    <div className="bg-white rounded-lg p-4 md:p-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
        <h1 className="text-lg font-semibold text-gray-800 mb-2 md:mb-0">Class Progress</h1>
