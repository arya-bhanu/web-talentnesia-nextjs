...
import { ColumnChart, ColumnChart2 } from './components/column-chart/ColumnChart';
...
const DashboardAdminView: React.FC<DashboardAdminViewProps> = ({ data, loading, error }) => {
      ...
      <div className="grid grid-cols-3 gap-5 mb-6 h-32">
        <div className="bg-[#FFE2E6] overflow-hidden shadow sm:rounded-lg flex p-6 relative">
          ...
          <div className="pl-3 mt-10  flex flex-col items-start">
            <div className='flex items-start pt-2'>
              <div className="text-xl leading-9 font-bold text-gray-900">{imageData.instructorData.data}</div>
              <div className="text-md leading-5 font-medium text-gray-900 pl-2 pt-2">Instructor</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#FFF4DC] overflow-hidden shadow sm:rounded-lg flex p-6 relative">
          ...
          <div className="mt-10 pl-3 flex flex-col">
            <div className='flex items-start pt-2'>
              <div className="text-xl leading-9 font-bold text-gray-900">{imageData.studentData.data}</div>
              <div className="text-md leading-5 font-medium text-gray-900 pl-2 pt-2">Active Students</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#D8F1D9] overflow-hidden shadow sm:rounded-lg flex p-6 relative">
          ...
          <div className=" pl-3 mt-10 flex flex-col">
            <div className='flex items-start pt-2'>
              <div className="text-xl leading-9 font-bold text-gray-900">{imageData.courseData.data}</div>
        ...
        <div className="grid grid-cols-1 gap-5 w-[280px] h-full ml-auto">
          <div className="bg-white overflow-hidden shadow sm:rounded-lg flex items-center p-4">
            <div className="flex items-center justify-end">
              ...
              <div className="flex flex-col">
                <div className="text-md leading-5 font-medium text-gray-900 font-poppins">Total E-Learning</div>
                <div className='flex items-center justify-between'>
                  <div className='flex flex-col items-center'>
                    <div className="text-xl leading-9 font-semibold text-[#957BF9]">{imageData.eLearningData.data}</div>
                  </div>
          ...
          <div className="bg-white overflow-hidden shadow sm:rounded-lg flex items-center p-4">
            <div className="flex items-center">
              ...
              <div className="flex flex-col">
                <div className="text-md leading-5 font-medium text-gray-900 font-poppins">Total Bootcamp</div>
                <div className='flex items-center justify-between'>
                  <div className='flex flex-col items-start'>
                    <div className="text-xl leading-9 font-semibold text-[#58A6FB]">{imageData.bootcampData.data}</div>
                  </div>
                  <div className='flex flex-col place-items-center pl-2 mr-auto'>
          ...
          <div className="bg-white overflow-hidden shadow sm:rounded-lg flex items-center p-4">
            <div className="flex items-center">
              ...
              <div className="flex flex-col">
                <div className="text-md leading-5 font-medium text-gray-900 font-poppins">Total IICP</div>
                <div className='flex items-center justify-between'>
                  <div className='flex flex-col items-start'>
                    <div className="text-xl leading-9 font-semibold text-[#44C5B1]">{imageData.iicpData.data}</div>
                  </div>
                  <div className='flex flex-col items-start'>
