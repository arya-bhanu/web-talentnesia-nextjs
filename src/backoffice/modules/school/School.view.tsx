...
const SchoolView: React.FC<SchoolProps> = ({
  data,
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-5">
        ...
        <Link
          href="/backoffice/school/add-school"
          className="flex items-center focus:outline-none text-white bg-[#FFC862] hover:bg-yellow-400 focus:ring-4 focus:ring-yellow-500 font-medium rounded-lg text-sm px-5 py-2.5"
        >
          <Add />
          <span className="text-black"> Add Course</span>
        </Link>
      </div>
      <div className="overflow-x-auto max-h-[60vh] overflow-y-auto shadow-md sm:rounded-lg">
        {data ? (
