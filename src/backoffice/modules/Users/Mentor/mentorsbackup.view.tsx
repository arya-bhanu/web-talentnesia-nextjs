...
import { Component as FileInput } from '@/backoffice/components/file-input/FileInput';
import { ProfilePictureInput } from '@/backoffice/components/profile-picture-input/ProfilePictureInput';
                ...
                <div className="border p-4 md:p-6 rounded-lg shadow-sm bg-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="religion" onChange={handleChange} aria-placeholder='Select Region' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white   font-poppins">
                                <option className='hidden' value={''} disabled selected>Select Religion</option>
