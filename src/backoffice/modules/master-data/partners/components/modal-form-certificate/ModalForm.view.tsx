      ...
      <form onSubmit={(e) => { e.preventDefault(); handleSave(); }}>
        <Modal.Body>
          <div className="space-y-4">
            ...
            <div>
            <label className="block mb-2 text-sm font-medium text-gray-900">Partner logo<label className="text-red-500">*</label></label>
              <FileInput label="Partner's Logo" id='logo' />
