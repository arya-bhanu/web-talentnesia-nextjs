...
interface AttendanceViewProps {
  ...
  onSort: (column: keyof AttendanceData) => void;
  sortColumn: keyof AttendanceData;
...
const AttendanceView: React.FC<AttendanceViewProps> = ({
  ...
  const renderSortArrow = (column: keyof AttendanceData) => {
  ...
  const applyFilterLogic = (data: AttendanceData[]) => {
